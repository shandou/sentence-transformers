...
n_trees = (
    256  # Number of trees used for Annoy. More trees => better recall, worse run-time
)
...
while True:
    ...
    corpus_ids, scores = annoy_index.get_nns_by_vector(
        question_embedding, top_k_hits, include_distances=True
    )
    hits = []
