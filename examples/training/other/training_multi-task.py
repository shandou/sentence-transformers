...
train_dataloader_nli = DataLoader(
    train_nli_samples, shuffle=True, batch_size=batch_size
)
...
train_dataloader_sts = DataLoader(
    train_sts_samples, shuffle=True, batch_size=batch_size
)
...
warmup_steps = math.ceil(
    len(train_dataloader_sts) * num_epochs * 0.1
...
train_objectives = [
    (train_dataloader_nli, train_loss_nli),
...
test_evaluator = EmbeddingSimilarityEvaluator.from_input_examples(
    test_sts_samples, name="sts-test"
)
