...
max_seq_length = 128
use_amp = (
    True  # Set to False, if you use a CPU or your GPU does not support FP16 operations
)
...
train_dataloader = MultiDatasetDataLoader(
    datasets, batch_size_pairs=batch_size_pairs, batch_size_triplets=batch_size_triplets
)
